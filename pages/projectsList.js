        ...
        <div className={classes.root}>
            ...
            <main className={classes.content}>
                ...
                <Container maxWidth={false} className={classes.container}>
                    ...
                    <ListProjects projectsList={props.projectsList} />
                </Container>
            </main>
        </div>
    );
...
ProjectsList.getInitialProps = async ctx => {
    const projectsList = await projectsServices.getProjects(ctx);

    return {projectsList: projectsList.data.data};
}


export default withAuthSync(ProjectsList, ['employee', 'admin'])