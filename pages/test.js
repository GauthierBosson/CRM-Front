                                ...
                                <Table className={classes.Table} aria-label="simple table">
                                    ...
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell align="left"><TextField label="Prix unitaire" id="prix" defaultValue="" size="small" /></TableCell>
                                            <TableCell align="left"><TextField label="Quantité" id="quantite" defaultValue="" size="small" /></TableCell>
                                            <TableCell align="left"><TextField label="Total" id="total" defaultValue="" size="small" /></TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell component="th" scope="row">
